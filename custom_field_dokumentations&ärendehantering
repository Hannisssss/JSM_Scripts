...
// Fältnamn
def fieldName = "Vilket verktyg inom Dokumentations & ärendehantering?"
def description  = "" 
...
// Skapa alternativ
optionsMgr.createOption(fieldConfig, null, 1L, "Confluence")
optionsMgr.createOption(fieldConfig, null, 2L, "Jira")
optionsMgr.createOption(fieldConfig, null, 3L, "Mimer")
optionsMgr.createOption(fieldConfig, null, 4L, "Sharepoint")
optionsMgr.createOption(fieldConfig, null, 5L, "Storegate")




log.warn("Custom field '$fieldName' skapades med alternativen: Confluence, Jira, Mimer, Sharepoint, Storegate.")
